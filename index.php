...
<head>
    ...
    <style>
        ...
        /* --- Product Card --- */
        .product-card { border: none; border-radius: 25px; transition: 0.4s; background: #fff; height: 100%; border: 1px solid #f0f0f0; }
        ...
        <div class="col-lg-3 d-none d-lg-block">
            <div class="sticky-top" style="top: 110px;">
                <div class="cat-group">
                    ...
                    <a href="index.php?cat=รองเท้าฟุตบอล" class="filter-btn <?php echo ($cat == 'รองเท้าฟุตบอล') ? 'active' : ''; ?>">รองเท้าฟุตบอล</a>
                    <a href="index.php?cat=รองเท้าบาสเกตบอล" class="filter-btn <?php echo ($cat == 'รองเท้าบาสเกตบอล') ? 'active' : ''; ?>">รองเท้าบาสเกตบอล</a>
                    <a href="index.php?cat=รองเท้าผ้าใบ" class="filter-btn <?php echo ($cat == 'รองเท้าผ้าใบ') ? 'active' : ''; ?>">รองเท้าผ้าใบ</a>

                    <div class="cat-header mt-3">เสื้อผ้า (Apparel)</div>
                    <a href="index.php?cat=เสื้อกีฬา" class="filter-btn <?php echo ($cat == 'เสื้อกีฬา') ? 'active' : ''; ?>">เสื้อกีฬา</a>
                    <a href="index.php?cat=กางเกงกีฬา" class="filter-btn <?php echo ($cat == 'กางเกงกีฬา') ? 'active' : ''; ?>">กางเกงกีฬา</a>
